// // This controller is excluded from build.
// // Page creation is now handled by the page_manager ajax endpoint (handleAjaxCreatePage).
...
// 	data.request = r
// 	data.name = req.GetStringTrimmed(r, "page_name")
